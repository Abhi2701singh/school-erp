...
class School(models.Model):
    ...
    phone = models.CharField(max_length=20, blank=True, default="", verbose_name=_("Contact Phone"))
    email = models.EmailField(blank=True, default="", verbose_name=_("Contact Email"))
    website = models.URLField(blank=True, null=True, verbose_name=_("Website"))
    principal_name = models.CharField(max_length=150, blank=True, default="", verbose_name=_("Principal Name"))
    affiliation_no = models.CharField(max_length=100, blank=True, default="", verbose_name=_("Affiliation No."))
